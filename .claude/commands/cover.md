...
This past summer, as a Software Engineer Intern at Dimensional Fund Advisors, I built a Python pipeline that parsed thousands of YAML-based dbt schema files across a large data warehouse, resolving more than 44,900 data mismatches for a firm managing over $1 trillion in assets. [Optional: one sentence connecting this directly to something in the job posting.] That work required exactly the kind of technical rigor and comfort with ambiguity that [Company/role] demands.
